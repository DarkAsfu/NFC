...
import { Mail, Phone, MapPin, Globe, Briefcase, GraduationCap, Award, Languages, BookOpen, Users } from 'lucide-react'

export default function CV5_Student({ user, profile, about, contactInfo, skills, experiences, educations, languages, certificates }) {
  ...
  return (
    <div className="bg-white text-gray-900 print:p-0" style={{ maxWidth: '210mm', margin: '0 auto', padding: '40px' }}>
      {/* Header - Student Focused */}
      <div className="bg-blue-700 text-white p-8 rounded-lg mb-6">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="col-span-2 space-y-6">
          ...
          {educations?.length > 0 && (
            <section>
              ...
              <div className="space-y-5">
                {educations.map((edu) => (
                  <div key={edu.id} className="border-l-4 border-blue-700 pl-4 pb-4">
                    <h3 className="text-xl font-semibold text-gray-900">{edu.degree || edu.field_of_study}</h3>
                    <p className="text-blue-700 font-medium text-lg">{edu.institution}</p>
          ...
          {experiences?.length > 0 && (
            <section>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Experience & Internships</h2>
              </div>
              <div className="space-y-4">
                {experiences.map((exp) => (
                  <div key={exp.id} className="border-l-4 border-blue-700 pl-4">
          ...
          {/* Certificates - Important for Students */}
              ...
              <div className="space-y-3">
                {certificates.map((cert) => (
                  <div key={cert.id} className="flex items-start gap-3">
                    <Award className="h-5 w-5 text-blue-700 mt-0.5 shrink-0" />
                    <div>
        ...
        <div className="space-y-6">
          ...
          {about?.about && (
            <section>
              ...
              <p className="text-gray-700 text-sm leading-relaxed">{about.about}</p>
            </section>
          )}
        </div>
      </div>
